...
public class ClassFile {
    public static void main(String[] args) {
        ...
        // вариант 1 Создание объекта File, представляющего каталог D://javaFile
        File dir1 = new File("D:\\javaFile");

        // вариант 2 Создание объекта File, представляющего файл "test.txt" в каталоге dir
        File file1 = new File(dir1, "text1.txt");

        // вариант 3 Создание объекта File, представляющего файл "test.txt" в каталоге "D://javaFile"
        ...
        System.out.println(file.getParentFile());          // каталог папки или файла где находится каталог или файл File
